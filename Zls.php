 ...
 * @since         v2.6.2
 * @updatetime    2021-09-27 14:05:54
 */
define('IN_ZLS', '2.6.2');
...
class ZlsDatabaseActiverecord extends Zls_Database
{
    public $arFrom;
 ...
 */
abstract class ZlsController
{
}
abstract class ZlsInstance
{
    /**
     * @return static
     */
...
abstract class ZlsModel extends Zls_Instance
{
}
abstract class ZlsBusiness extends Zls_Instance
{
    protected $error = '';
...
class ZlsRouterPathinfo extends Zls_Router
{
    private $isPathinfo;
...
abstract class ZlsTaskSingle extends Zls_Task
{
    public function _execute($args)
    {
        $class = get_class($this);
...
abstract class ZlsTaskMultiple extends Zls_Task
{
    public function _execute($args)
    {
        $class = get_class($this);
...
abstract class ZlsException extends \Exception
{
...
abstract class ZlsSession implements \SessionHandlerInterface
{
    protected $config;
    /**
...
class ZlsExceptionExit extends Exception
{
}
class ZlsException404 extends Zls_Exception
{
...
class ZlsException500 extends Zls_Exception
{
...
class ZlsExceptionDatabase extends Zls_Exception
{
...
class ZlsRequestDefault implements Zls_Request
{
    public function __construct()
    {
 ...
 * @method callable                     getBootstrapHandle()
...
class ZlsMaintainHandleDefault implements Zls_Maintain_Handle
{
    public function handle()
    {
        if (!Z::isCli()) {
...
class ZlsUriRewriterDefault implements Zls_Uri_Rewriter
{
    public function rewrite($uri)
    {
        return $uri;
...
class ZlsExceptionHandleDefault implements Zls_Exception_Handle
{
    public function handle(\Zls_Exception $exception)
    {
        $exception->render();
...
class ZlsDatabaseSlowqueryHandleDefault implements Zls_Database_SlowQuery_Handle
{
    public function handle($sql, $value, $explainString, $time, $trace)
    {
...
class ZlsDatabaseIndexHandleDefault implements Zls_Database_Index_Handle
{
    public function handle($sql, $value, $explainString, $time, $trace)
    {
        $content = 'SQL : ' . $sql . PHP_EOL . 'value : ' . $value . PHP_EOL . 'explain : ' . $explainString . PHP_EOL . 'usingtime : ' . $time . 'ms' . PHP_EOL . 'time : ' . date('Y-m-d H:i:s');
...
class ZlsCacheFile implements Zls_Cache
{
